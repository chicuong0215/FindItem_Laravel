...
<body style="text-align:left">
    <div class="main_device">
        ...
        @endif
        @if($baiDang['active']==1)
            <a href="{{route('xoa-bai-dang-2',['id'=>$baiDang['id']])}}"><button class="buy" style="margin-bottom: 10px;background-color:{{$baiDang['stt']==1?'red':'blue'}}">{{$baiDang['stt']==1?'Xóa bài đăng':'Khôi phục'}}</button></a>
            @endif
        </div>
        <img src="" class="bg" />
    </div>
