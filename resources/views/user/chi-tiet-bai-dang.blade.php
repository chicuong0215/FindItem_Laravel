...
<body style="text-align:left">
    <div class="main_device">
        ...
        <div class="right">
            ...
            <br>
            <b>Người đăng:</b> {{$baiDang['id_account']}}
            <h4 class="details"><b>Tiêu đề:</b> {{$baiDang['title']}}</h4>
            <h4 class="details"><b>Nội dung:</b> {{$baiDang['content']}}</h4>
            <h4 class="details"><b>Loại:</b> {{$baiDang['id_type']=='find'?'Tìm đồ':'Nhặt đồ'}}</h4>
            <h4 class="details"><b>Nội dung:</b> {{$baiDang['content']}}</h4>
            <b>Ngày đăng:</b> {{$baiDang['created_at']}}<br>
            <br>
